...
type PrismaParameters<T extends Table, O extends Operation<T>> = Parameters<PrismaClient[T][O]>[0]["data"];
...
export declare namespace Api {
    type RowOptions = {
         ...
         */
        encryption?: SupportedEncryptionAlgorithms | {
    ...
    type GlobalOptions = WithRequired<Partial<{
         ...
         */
        disableGlobalFetching: Partial<Record<Table, {
